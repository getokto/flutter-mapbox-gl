...
internal object Convert {
    ...
    fun toCameraPosition(o: Any?): CameraPosition {
        ...
        builder.bearing(toFloat(data!!.get("bearing")).toDouble())
        builder.target(toLatLng(data.get("target")))
        builder.tilt(toFloat(data.get("tilt")).toDouble())
        builder.zoom(toFloat(data.get("zoom")).toDouble())
    ...
    private fun toLatLngBounds(o: Any?): LatLngBounds? {
        ...
        val bounds = Arrays.asList(*boundsArray)
